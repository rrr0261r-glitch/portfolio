    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                avatar-md">
                @else
                <i class="fa-solid fa-circle-user text-secondary d-block mx-auto icon-md"></i>
                @endif
            </td>
            <td>
            ...
            <td>
                @if($user->trashed())
                <!-- trashed() will return TRUE if the record was soft delated -->
